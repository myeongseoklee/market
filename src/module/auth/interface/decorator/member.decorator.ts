 ...
 * @returns {AuthProvider} authProvider - 요청 객체에서 추출된 사용자 정보
 */

export const GetAuthProvider = createParamDecorator(
  (data: unknown, ctx: ExecutionContext): AuthProvider => {
    const req = ctx.switchToHttp().getRequest();
    return req.user as AuthProvider;
  },
);
